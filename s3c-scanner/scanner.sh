...
echo "----- $image_name"
#image_name="gcr.io/ah-crm-common-gke-np-105/state-manager"
...
#    echo "gcloud beta container binauthz attestations sign-and-create --project $PROJECT_ID --artifact-url $image_name@$digest_value --attestor $BA_VULNERABILITY_ATTESTOR --attestor-project $PROJECT_ID --keyversion 1 --keyversion-key $BA_KEY --keyversion-location us-central1 --keyversion-keyring $BA_KEYRING --keyversion-project $PROJECT_ID"
#    gcloud beta container binauthz attestations sign-and-create --project $PROJECT_ID --artifact-url $image_name@$digest_value --attestor $BA_VULNERABILITY_ATTESTOR --attestor-project $PROJECT_ID --keyversion "1" --keyversion-key $BA_KEY --keyversion-location "us-central1" --keyversion-keyring $BA_KEYRING --keyversion-project $PROJECT_ID
    ...
    #echo "gcloud beta container binauthz attestations sign-and-create --project $PROJECT_ID --artifact-url $image_name@$digest_value --attestor vulnerability-attestor --attestor-project $PROJECT_ID --keyversion 1 --keyversion-key vulnerability-signer --keyversion-location us-central1 --keyversion-keyring binaryauthz --keyversion-project $PROJECT_ID"
    #gcloud beta container binauthz attestations sign-and-create --project $PROJECT_ID --artifact-url $image_name@$digest_value --attestor "vulnerability-attestor" --attestor-project $PROJECT_ID --keyversion "1" --keyversion-key "vulnerability-signer" --keyversion-location "us-central1" --keyversion-keyring "binaryauthz" --keyversion-project $PROJECT_ID
